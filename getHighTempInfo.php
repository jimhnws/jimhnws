...
<script>
  function load_anotherpage() {
    document.getElementById("display1").innerHTML =
      '<embed type="text/html" src="http://3.135.162.69/pivotHigh.html" width="1500" height="1500">';
  }

  load_anotherpage();
</script>

<div class="newerImages" style="position: absolute;top: 0;left: 50%;"><img id="x" src = 'http://3.135.162.69/pivotHigh.png' width="850" height="700" ></div> 
